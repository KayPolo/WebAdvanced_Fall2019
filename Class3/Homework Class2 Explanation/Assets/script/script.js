...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // let pickYellow = document.getElementById("pickYellow");
    // pickYellow.style.display = "none";

    // let pickTeal = document.getElementById("pickTeal");
    // pickTeal.style.display = "none";
